    ...
    public function run(): void
    {
        $contents = [
            ...
            [
                'group' => 'faq',
                'key' => 'faq_2_question',
                'value' => 'How long does a typical construction project take?',
                'type' => 'text',
            ...
            [
                'group' => 'faq',
                'key' => 'faq_2_answer',
                'value' => 'Timeline depends on the project scope. Residential homes typically take 6-12 months, while smaller renovations may take 2-4 months.',
                'type' => 'textarea',
                'label' => 'FAQ 2 Answer',
            ],
            [
                'group' => 'faq',
                'key' => 'faq_3_question',
                'value' => 'Do you provide free estimates?',
                'type' => 'text',
            ...
            [
                'group' => 'faq',
                'key' => 'faq_3_answer',
                'value' => 'Yes, we provide initial consultations and detailed project estimates free of charge to help you plan your budget.',
                'type' => 'textarea',
                'label' => 'FAQ 3 Answer',
            ],
            [
                'group' => 'faq',
                'key' => 'faq_4_question',
                'value' => 'Are you licensed and insured?',
                'type' => 'text',
            ...
            [
                'group' => 'faq',
                'key' => 'faq_4_answer',
                'value' => 'Absolutely. We are fully licensed, bonded, and insured to ensure complete protection for our clients and workers.',
                'type' => 'textarea',
                'label' => 'FAQ 4 Answer',
            ],
            [
            ...
            [
                'group' => 'faq',
                'key' => 'faq_5_answer',
                'value' => 'We currently serve the metropolitan area and surrounding suburbs within a 100-mile radius.',
                'type' => 'textarea',
                'label' => 'FAQ 5 Answer',
            ],
            [
                'group' => 'faq',
                'key' => 'faq_6_question',
                'value' => 'How do you handle project delays?',
                'type' => 'text',
            ...
            [
                'group' => 'faq',
                'key' => 'faq_6_answer',
                'value' => 'We maintain proactive communication. If delays occur due to weather or supply issues, we adjust schedules and keep you updated immediately.',
                'type' => 'textarea',
                'label' => 'FAQ 6 Answer',
            ],
        ];
