...
class UpdateSiteManagerRequest extends FormRequest
{
    /**
    ...
    {
        $siteManagerId = $this->route('site_manager')->id;

        return [
            'name' => 'required|string|max:255',
            'email' => 'required|email|max:255|unique:site_managers,email,' . $siteManagerId . '|unique:users,email,' . ($this->route('site_manager')->user_id ?? 'NULL'),
