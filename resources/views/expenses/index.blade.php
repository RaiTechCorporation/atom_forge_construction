                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-6 text-center">
                                    @if($expense->bill_path)
                                        <a href="{{ Storage::url($expense->bill_path) }}" target="_blank" class="inline-flex items-center justify-center p-2 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all" title="View Receipt">
