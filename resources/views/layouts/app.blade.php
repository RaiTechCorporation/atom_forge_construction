...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased text-slate-900 bg-slate-50" x-data="{ sidebarOpen: false }">
        ...
        <a href="https://wa.me/918318754257" target="_blank" class="fixed bottom-[15%] right-8 z-[90] bg-emerald-500 text-white p-4 rounded-full shadow-2xl hover:bg-emerald-600 transition-all transform hover:scale-110 flex items-center justify-center group" title="Chat with us on WhatsApp">
