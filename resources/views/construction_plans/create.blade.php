        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 py-2">
            <div>
                ...
                <p class="mt-1 text-base font-bold text-slate-800 uppercase tracking-widest text-[10px]">
                    {{ __('Deploy new construction plan configuration') }}
                </p>
            </div>
    ...
    <div class="py-12 bg-white min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-[2.5rem] border-4 border-black p-10 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
                <form action="{{ route('construction-plans.store') }}" method="POST" class="space-y-10">
                    @csrf
                    ...
                    <div class="pt-6 border-t-4 border-black">
                        <button type="submit" class="w-full py-6 bg-yellow-400 border-4 border-black rounded-2xl font-black text-base text-black hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-400/50 active:scale-[0.98] transition-all duration-200 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] uppercase tracking-widest active:translate-x-1 active:translate-y-1 active:shadow-none">
