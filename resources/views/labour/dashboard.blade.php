        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm group hover:shadow-md transition-all">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Total Force</span>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-8 py-12 text-center text-slate-500 font-medium">No recent activity recorded.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
