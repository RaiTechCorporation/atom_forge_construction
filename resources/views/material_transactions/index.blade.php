                                ...
                                <tr class="hover:bg-slate-50 transition-colors group">
                                    ...
                                    <td class="px-8 py-8 border-r-2 border-slate-100 text-center">
                                        @if($transaction->bill_path)
                                            <a href="{{ asset('storage/' . $transaction->bill_path) }}" target="_blank" class="inline-flex items-center justify-center w-10 h-10 bg-white border-2 border-black rounded-lg hover:bg-slate-900 hover:text-white transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]" title="View Document">
