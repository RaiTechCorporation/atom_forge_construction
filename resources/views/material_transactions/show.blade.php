                                ...
                                <div>
                                    ...
                                    <dd>
                                        @if($materialTransaction->bill_path)
                                            <a href="{{ asset('storage/' . $materialTransaction->bill_path) }}" target="_blank" class="inline-flex items-center gap-3 px-6 py-3 bg-black text-white rounded-xl font-black uppercase tracking-widest text-xs hover:bg-slate-800 transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)]">
