            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                <div class="relative">
                    ...
                    <div class="rounded-[3rem] overflow-hidden shadow-2xl border border-slate-100 aspect-square">
                        <img src="https://images.unsplash.com/photo-1541888946425-d81bb19480c5?auto=format&fit=crop&q=80&w=1200" alt="Construction Planning" class="w-full h-full object-cover">
                    </div>
                </div>
                <div>
                    <span class="text-blue-600 font-bold uppercase tracking-widest text-xs mb-4 block">Introduction</span>
    ...
    <section class="py-24 bg-slate-50 border-y border-slate-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-20">
                <span class="text-blue-600 font-bold uppercase tracking-widest text-xs mb-4 block">Our DNA</span>
            ...
            <div class="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="{{ route('contact') }}" class="w-full sm:w-auto px-10 py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20">Connect With Us</a>
